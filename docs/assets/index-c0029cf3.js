...
var require_index_001 = __commonJS({
  "assets/index-c0029cf3.js"(exports, module) {
    (function polyfill() {
    ...
    const searchMuseumData = async (options) => {
      const { lang, apiKey: apiKey2, color, involvedMaker, search } = options;
      const urlParams = `${URL$1}&q=${search}`;
...
//# sourceMappingURL=index-c0029cf3.js.map
